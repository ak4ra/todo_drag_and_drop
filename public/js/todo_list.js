...
function createListItem(itemText, i) {
...
function mouseDownHandler(event) {
    ...
    if (draggingElement.classList.contains("todo-list_item_delete-button"))
        return;
...
function mouseMoveHandler(event) {
    ...
    const bottomLimit = todoList.getBoundingClientRect().bottom - draggingElement.getBoundingClientRect().height + window.scrollY;
    switch (true) {
